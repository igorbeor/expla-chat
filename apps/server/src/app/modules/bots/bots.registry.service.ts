...
export class BotsRegistryService {
  private readonly strategies: Map<BotTypes, BotStrategy> = new Map();
  ...
  constructor(
    ...
    this.strategies.set(BotTypes.ECHO, this.echoBot);
    this.strategies.set(BotTypes.REVERSE, this.reverseBot);
    this.strategies.set(BotTypes.IGNORE, this.ignoreBot);
    this.strategies.set(BotTypes.SPAM, this.spamBot);
  }

  public get(type: BotTypes): BotStrategy {
